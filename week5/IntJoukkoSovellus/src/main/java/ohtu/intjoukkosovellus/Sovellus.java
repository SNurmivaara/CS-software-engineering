...
public class Sovellus {
    ...
    private static IntJoukko kysyJoukko(int mones) {
        System.out.println(mones + ". joukko?");
        return mikaJoukko();
    }

    private static void yhdiste() {
        IntJoukko c = IntJoukko.yhdiste(kysyJoukko(1), kysyJoukko(2));
        System.out.println("A yhdiste B = " + c.toString());
        return;
    }

    private static void leikkaus() {
        IntJoukko c = IntJoukko.leikkaus(kysyJoukko(1), kysyJoukko(2));
        System.out.println("A leikkaus B = " + c.toString());
        return;
    }

    private static void erotus() {
        IntJoukko c = IntJoukko.erotus(kysyJoukko(1), kysyJoukko(2));
